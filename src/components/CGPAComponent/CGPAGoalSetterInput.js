...
import CGPAGoalSetterInputCom from './CGPAGoalSetterInputCom';
import Layout from 'components/Layout';


const CGPAGoalSetterInput = () => {
  return (
    <>
    <Layout>
    <Sidebar />
...
export default CGPAGoalSetterInput