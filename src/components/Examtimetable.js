...
const Examtimetable = () => {
  ...
  <Layout>
   ...
   <Link to="/coursetimetable">
      ...
      <FlexColumn>
        <Link>
        <CourseTimeTable>Exam time table</CourseTimeTable>
